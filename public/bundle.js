...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var AddItem = __webpack_require__(158); // her får parenten en child
	var List = __webpack_require__(159);	// her får parenten en child
			...
			return (
				React.createElement("div", {className: "col-sm-6 col-md-offset-3"}, 
					React.createElement("div", {className: "col-sm-12"}, 
						React.createElement("h3", {className: "text-center"}, " To Do List "), 
	...
	var List = React.createClass({displayName: "List",
		render: function() {
			...
			var listItems = this.props.items.map(
				// item: 1, 2, 3, 4, 5 index: the index of the items
				function(item, index) {
					return (
